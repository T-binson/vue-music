  ...
  <div class="music-list">
    ...
    <div class="bg-image" :style="bgstyle" ref="bgImg">
      <div class="play-wrapper">
        <div class="play" v-show="songs.length>0" ref="playBtn" @click="randomPlaying">
          <i class="icon-play"></i>
    ...
    <div class="bg-layer" ref="bgIayer"></div>
...
export default {
  ...
  watch: {
    scrollY(newY) {
      ...
      this.$refs.bgIayer.style[transform] = `translate3d(0, ${translateY}px, 0)`
