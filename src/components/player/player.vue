          ...
          <div class="middle-l" ref="middleL">
            <div class="cd-wrapper" ref="cdWrapper">
              <div class="cd" ref="imageWrapper">
                <img :src="currentSong.image" alt="" class="image" :class="cdCls" ref="image">
              </div>
            </div>
      ...
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <div class="imgWrapper" ref="miniWrapper">
            <img width="40" height="40" :src="currentSong.image" alt="" :class="cdCls" ref="miniImage">
          </div>
        </div>
        <div class="text">
...
export default {
  ...
  methods: {
    ...
    leave(el, done) {
      ...
      // 下面注释代码会导致player的v-show=fullScreen失效
...
.player
  .normal-player
    ...
    &.normal-center-active, &.normal-leave-active
      transition: all 0.4s
      .top, .bottom
